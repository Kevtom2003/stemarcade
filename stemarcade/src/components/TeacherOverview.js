    ...
    return (
      ...
      <div className="screen">
        <div className="teacher-options">
          <h3 onClick={() => setCurrView("View")} className="clickable">
            View
          </h3>
          <h3 onClick={() => setCurrView("Create")} className="clickable">
            Create
          </h3>
          <h1>Teacher Dashboard</h1>
          <h3 onClick={() => setCurrView("Update")} className="clickable">
            Update
          </h3>
          <h3 onClick={() => setCurrView("Delete")} className="clickable">
            Delete
          </h3>
        </div>
        {currView === "View" && (
